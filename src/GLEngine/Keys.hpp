...
#define KEY_LSHIFT    (OFFSET + GLUT_KEY_SHIFT_L)
#define KEY_RSHIFT    (OFFSET + GLUT_KEY_SHIFT_R)
#define KEY_LCTRL     (OFFSET + GLUT_KEY_CTRL_L)
#define KEY_RCTRL     (OFFSET + GLUT_KEY_CTRL_R)
#define KEY_LALT      (OFFSET + GLUT_KEY_ALT_L)
#define KEY_RALT      (OFFSET + GLUT_KEY_ALT_R)
